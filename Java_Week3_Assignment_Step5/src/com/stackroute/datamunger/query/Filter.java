...
public class Filter {
	...
	public Boolean evaluateExpression(Header header, RowDataTypeDefinitions dataTypeDef, String[] data,
		...
		for (int i = 0; i < r.size(); i++) {
			...
			if (r.get(i).getCondition().equals("!=")) {
				if (dataTypeDef.get(header.get(r.get(i).getPropertyName().trim())).equals("java.lang.String")) {
					String conditionValue = r.get(i).getPropertyValue().trim().toLowerCase();
					String rowDataValue = data[header.get(r.get(i).getPropertyName().trim())].toLowerCase();
					list.add(conditionIsNotEqualTo(rowDataValue, conditionValue));
				}
				if (dataTypeDef.get(header.get(r.get(i).getPropertyName().trim())).equals("java.lang.Integer")) {
					int conditionValue = Integer.parseInt(r.get(i).getPropertyValue().trim());
					int rowDataValue = Integer.parseInt(data[header.get(r.get(i).getPropertyName().trim())]);
					list.add(conditionIsNotEqualTo(rowDataValue, conditionValue));
				}
			...
			if (r.get(i).getCondition().equals("=")) {
				if (dataTypeDef.get(header.get(r.get(i).getPropertyName().trim())).equals("java.lang.String")) {
					String conditionValue = r.get(i).getPropertyValue().toLowerCase().trim();
					String rowDataValue = data[header.get(r.get(i).getPropertyName().trim())].toLowerCase();
